...
export const deleteDb = async (id) =>{
    ...
    //create a connection to the IndexedDB database and the verstion we want to use.
    const contactDb=await openDB('contact_db', 1);
    ...
    //use the .delete() metod to get all data in the database.
...
export const  editDb = async (id, name, email, phone, profile)=>{
    ...
    //create a conenction the IndexedDB database and the version we are using.
    const contactDb= await openDB('contact_db', 1);
